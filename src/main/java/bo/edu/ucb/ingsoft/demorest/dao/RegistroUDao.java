...
public class RegistroUDao {
    ...
    public RegistroUDto findRegistroUById(Integer id_owner) {
        ...
        //       PreparedStatement pstmt = conn.prepareStatement("Select id_person, first_name, last_name, email, date_of_birth, phone_number, address, city from person where id_owner=? ");
        ){ //TRY WITH RESOURCES
